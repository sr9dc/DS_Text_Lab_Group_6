...
```{r}
LA_Times_raw <- as_tibble(read_rtf("Los_Angeles_Times_Articles.RTF", skip = 0))
Eurasia_raw <- as_tibble(read_rtf("Eurasia_Review_articles.RTF", skip = 0))
Spokesman_raw <- as_tibble(read_rtf("Spokesman_Review_Articles.RTF", skip = 0))
Combined_raw <- as_tibble(read_rtf("Combined_West_Coast_Articles.RTF", skip = 0))
...
LA_Times_bag <- data_prep(LA_Times_raw, 'V1','V131')
Eurasia_bag <- data_prep(Eurasia_raw, 'V1','V131')
Spokesman_bag <- data_prep(Spokesman_raw, 'V1','V131')
Combined_bag <- data_prep(Combined_raw, 'V1','V131')
